    ...
    <span style={{ fontSize: "1.125rem", fontWeight: 700, letterSpacing: "0.01em" }}>
      Launching Soon on Play Store & App Store
          ...
          <div className="hero-sub-row fu fu3">
            <p>
              Real-time fan conversations, personalized sports feeds, prizes and local event discovery  one platform built for the culture.
            </p>
    ...
    <div>
      ...
      <div className="chat-features">
        {[
          ...
          { icon: "🎁", title: "Unlimited Prizes",      desc: "Win prizes weekly engaging in sports you love" },
